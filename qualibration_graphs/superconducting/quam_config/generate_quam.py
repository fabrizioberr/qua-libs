...
########################################################################################################################
host_ip = "18.25.11.83"  # QOP IP address
port = None  # QOP Port
...
instruments.add_mw_fem(controller=1, slots=[3])
...
q1to3_res_ch = mw_fem_spec(con=1, slot=3, in_port=2, out_port=1)
# individual xy drive for qubits 1 to 4 on MW-FEM 1
q1to3_drive_ch = mw_fem_spec(con=1, slot=3, in_port=None, out_port=None)
...
# The readout lines
connectivity.add_resonator_line(qubits=qubits[:3], constraints=q1to3_res_ch)
# The xy drive lines
connectivity.add_qubit_drive_lines(qubits=qubits[:3], constraints=q1to3_drive_ch)
